...
class MinHeap {
  ...
  push(node) {
    ...
    if (this.heap.length > 1) {
      ...
      /* Traversing up the parent node until the currentIndex node is greater than the parent (currentIndex/2) */
      while (
        currentIndex > 1 &&
        this.heap[getParentNodeIndex(currentIndex)] > this.heap[currentIndex]
      ) {
